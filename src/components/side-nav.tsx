...
export default function SideNav({ isCollapsed }: Props) {
	...
	return (
		<div data-collapsed={isCollapsed} className='h-[calc(100%-10px)] flex flex-col  gap-4'>
			<div className='h-14 border-b-2 grid place-content-center'>
				<Logo isCollapsed={isCollapsed} />
			</div>

			<div className='flex-1 flex flex-col justify-between'>
				<nav className='grid p-2 gap-2 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2  '>
